...
This final version is a runtime-driven 3D mobile puzzle prototype where the player must identify the correct falling target under timer pressure while separating real gameplay truth from misleading presentation.

The main strengths of the build are:

- clear system separation
- JSON-driven balancing
- pooled gameplay objects
- cleaned interview-ready script set
- improved final UI readability
